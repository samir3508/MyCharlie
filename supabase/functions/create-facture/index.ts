...
serve(async (req) => {
  ...
  try {
    ...
    // ÉTAPE 2 : Vérifier que le devis existe si devis_id est fourni et récupérer dossier_id
    ...
    if (devis_id) {
      ...
      // ✅ Récupérer le dossier_id du devis pour lier la facture au dossier
      dossier_id = devis.dossier_id || null
    }
    ...
    const { data: newFacture, error: createError } = await supabase
      ...
      .insert({
        ...
        dossier_id: dossier_id || null, // ✅ Lier au dossier du devis si disponible
