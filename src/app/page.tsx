          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div className="space-y-6" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                Le secrétaire <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">IA</span> des pros du bâtiment
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/signup">
                  <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-lg bg-gradient-to-r from-orange-500 to-orange-600">
                    Demander une démo gratuite<ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
                </Link>
                <a href="#comment-ca-marche">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto h-14 px-8 text-lg border-gray-700 text-gray-300">Comment ça marche ?</Button>
                </a>
              </div>
              <div className="flex flex-wrap gap-6 pt-6">
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-lg bg-orange-500/20 flex items-center justify-center"><Timer className="w-5 h-5 text-orange-500" /></div>
                  <div><p className="text-lg font-bold">5 min</p><p className="text-xs text-gray-400">Devis créé</p></div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-lg bg-orange-500/20 flex items-center justify-center"><Bell className="w-5 h-5 text-orange-500" /></div>
                  <div><p className="text-lg font-bold">Auto</p><p className="text-xs text-gray-400">Relances</p></div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div><p className="text-lg font-bold">100%</p><p className="text-xs text-gray-400">Suivi client</p></div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative z-10 flex justify-center">
                <div className="relative">
                  ...
                  <motion.div className="absolute -right-4 top-10 bg-gray-900 border border-gray-700 rounded-xl p-3 shadow-xl" animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity }}>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-green-500/20 flex items-center justify-center"><Send className="w-4 h-4 text-green-500" /></div>
                      <div><p className="text-xs font-medium">Devis envoyé</p><p className="text-xs text-gray-400">M. Dupont</p></div>
                    </div>
                  </motion.div>
                  <motion.div className="absolute -left-4 top-32 bg-gray-900 border border-gray-700 rounded-xl p-3 shadow-xl" animate={{ y: [0, 10, 0] }} transition={{ duration: 3.5, repeat: Infinity }}>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center"><Bell className="w-4 h-4 text-orange-500" /></div>
                      <div><p className="text-xs font-medium">Relance faite</p><p className="text-xs text-gray-400">Facture #1234</p></div>
                    </div>
                  </motion.div>
                  <motion.div className="absolute -right-8 bottom-20 bg-gray-900 border border-gray-700 rounded-xl p-3 shadow-xl" animate={{ y: [0, -8, 0] }} transition={{ duration: 4, repeat: Infinity }}>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center"><MessageSquare className="w-4 h-4 text-blue-500" /></div>
                      <div><p className="text-xs font-medium">Nouveau message</p><p className="text-xs text-gray-400">Via WhatsApp</p></div>
                    </div>
                  </motion.div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              { icon: Clock, text: "Tu perds du temps le soir et le week-end sur l'administratif" },
              { icon: FileText, text: "Créer un devis prend 30 minutes (parfois plus)" },
              { icon: DollarSign, text: "Tu oublies de relancer → paiements en retard" },
              { icon: Users, text: "Difficile de suivre qui doit quoi" },
            ].map((item, index) => (
              ...
              <div className="w-72 bg-gray-900 rounded-3xl border border-gray-700 p-4 shadow-2xl">
                ...
                <div className="bg-gray-800 rounded-2xl p-4">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center"><HardHat className="w-4 h-4 text-white" /></div>
                    <span className="font-medium">Charlie</span><span className="text-xs text-gray-400">08:00</span>
                  </div>
                  <div className="space-y-2 text-sm">
                    <p>Bonjour 👋</p><p>Aujourd&apos;hui :</p>
                    <p className="text-orange-400">• 2 factures à relancer</p>
                    <p className="text-orange-400">• 1 devis en attente de signature</p>
                    <p className="mt-2">Tu veux que je m&apos;en occupe ?</p>
                  </div>
                  <div className="flex gap-2 mt-4">
                    <button className="flex-1 py-2 bg-orange-500 rounded-lg text-sm font-medium">Oui, vas-y</button>
                    <button className="flex-1 py-2 bg-gray-700 rounded-lg text-sm">Plus tard</button>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="flex justify-center">
                <div className="w-64 h-80 bg-white rounded-xl shadow-2xl p-6 text-gray-900">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between"><span>Main d&apos;œuvre</span><span>2 400 €</span></div>
                    <div className="flex justify-between"><span>Fournitures</span><span>3 200 €</span></div>
                    <div className="border-t pt-2 flex justify-between font-bold"><span>Total TTC</span><span>5 600 €</span></div>
                  </div>
                  <div className="mt-6 pt-4 border-t">
                    <p className="text-xs text-gray-500 mb-2">Signature client</p>
                    <div className="h-16 border-2 border-dashed border-orange-300 rounded-lg flex items-center justify-center bg-orange-50"><span className="text-orange-500 text-xl italic">M. Martin</span></div>
                    <div className="flex items-center gap-1 mt-2 text-xs text-green-600"><CheckCircle2 className="w-3 h-3" /><span>Signé le 15/01/2025</span></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="faq" className="py-20 px-4 bg-black">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-0">
            {faqs.map((faq, index) => (<FAQItem key={index} question={faq.question} answer={faq.answer} isOpen={openFAQ === index} onClick={() => setOpenFAQ(openFAQ === index ? null : index)} />))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-orange-500/20 via-black to-orange-600/20">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-6">
            ...
            <div className="pt-6">
              <Link href="/signup"><Button size="lg" className="h-16 px-10 text-lg bg-gradient-to-r from-orange-500 to-orange-600">Demander une démo gratuite<ArrowRight className="ml-2 w-5 h-5" /></Button></Link>
              <p className="text-sm text-gray-400 mt-4">Démo gratuite • Sans engagement • Réponse en 24h</p>
            </div>
          </motion.div>
        </div>
      </section>
